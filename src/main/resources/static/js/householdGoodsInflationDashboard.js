...
(async () => {
    ...
    let response = await fetch("/api/household-goods/inflation")
    ...
    // Graphs
    const ctx = document.getElementById('householdGoodsInflation')
    ...
    let list = document.querySelector('.householdGoodsInflation')
